...
export interface NGINXIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
}

/** The NGINX brand mark, from simple-icons (CC0-1.0). */
export function NGINXIcon({ size = 16, ...rest }: NGINXIconProps) {
  return (
