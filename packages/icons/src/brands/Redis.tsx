...
export interface RedisIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
}

/** The Redis brand mark, from simple-icons (CC0-1.0). */
export function RedisIcon({ size = 16, ...rest }: RedisIconProps) {
  return (
