...
export interface MinIOIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
}

/** The MinIO brand mark, from simple-icons (CC0-1.0). */
export function MinIOIcon({ size = 16, ...rest }: MinIOIconProps) {
  return (
