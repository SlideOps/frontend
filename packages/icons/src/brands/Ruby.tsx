...
export interface RubyIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
}

/** The Ruby brand mark, from simple-icons (CC0-1.0). */
export function RubyIcon({ size = 16, ...rest }: RubyIconProps) {
  return (
