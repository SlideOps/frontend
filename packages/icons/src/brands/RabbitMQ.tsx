...
export interface RabbitMQIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
}

/** The RabbitMQ brand mark, from simple-icons (CC0-1.0). */
export function RabbitMQIcon({ size = 16, ...rest }: RabbitMQIconProps) {
  return (
