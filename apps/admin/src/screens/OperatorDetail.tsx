import { getOperator, suspendOperator, unsuspendOperator, ApiError } from '@slideops/api-client';
...
export function OperatorDetail() {
  ...
  return (
    <AdminShell active="operators">
      <Button variant="ghost" size="sm" className="mb-4" onClick={() => navigate('/operators')}>
