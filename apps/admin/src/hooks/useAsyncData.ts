...
/**
 * A small data-loading hook shared by the Admin screens. It runs an async loader,
 * tracks loading, error, and ready states, cancels a request in flight when its
 * inputs change, and offers a reload for actions that mutate what the screen
 * shows. Every screen reads the same way and no request outlives its screen.
 */
