import { Activity, FileText, LayoutDashboard, Layers, Server, Shield } from '@slideops/icons';
...
export type ActiveKey = 'home' | 'nodes' | 'capabilities' | 'operations' | 'reports' | 'security';
