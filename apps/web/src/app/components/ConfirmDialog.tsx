...
/*
 * A deliberate confirmation dialog for actions the Operator should pause on
 * before they run, such as rotating the connection credential or removing an
 * account. It does the accessible essentials: it labels itself, moves focus into
 * the dialog on open and restores it on close, closes on Escape and on a backdrop
 * click, and keeps Tab within its own controls.
 */
