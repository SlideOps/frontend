 ...
 * two eyes and the nose. The fills reference the Everlasting Beauty palette
 * variables through inline style because CSS var() is not read inside an SVG
 * fill attribute. The assemble motion lives in index.css as keyframes; the
 * resting, non-animated state of every piece is the fully assembled fox, so the
 * global reduced-motion guard leaves a complete mark rather than a half frame.
 */
